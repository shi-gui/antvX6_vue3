...
<template>
  <p class="mb-4">
    <a-button @click="test1">添加边的同时添加标签</a-button>
    <a-button @click="test2">二次设置标签</a-button>
    <a-button @click="test3">定制样式</a-button>
    <a-button @click="test4">实例：公交路线</a-button>
    <a-button @click="test5">内置箭头</a-button>
  </p>
  <div id="container" />
</template>
